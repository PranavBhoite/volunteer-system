...
const AccountConfirmation = () => {
  ...
  const fetchConfirmedAccounts = async () => {
    try {
      const response = await axios.get("api/admin/confirmed-accounts");
  ...
  const fetchDeclinedAccounts = async () => {
    try {
      const response = await axios.get("api/admin/declined-accounts");
  ...
  const handleApproval = async (userId) => {
    try {
      await axios.post(`api/admin/account-action`, {
        userId,
        action: "approved",
      });
            ...
            <Tab.Content>
              ...
              <Tab.Pane eventKey="pending" active={activeTab === "pending"}>
                {loading ? (
                  ...
                  <div className="text-center my-5 py-5">
                    <div className="mb-3">
                      <div className="rounded-circle bg-success text-white d-inline-flex align-items-center justify-content-center" style={{ width: '4rem', height: '4rem', fontSize: '2rem' }}>
              ...
              <Tab.Pane eventKey="approved" active={activeTab === "approved"}>
                {confirmedAccounts.length === 0 ? (
                  <div className="text-center my-5 py-5">
                    <div className="mb-3">
                      <div className="rounded-circle bg-info text-white d-inline-flex align-items-center justify-content-center" style={{ width: '4rem', height: '4rem', fontSize: '2rem' }}>
