...
export default function Sidebar() {
  ...
  const links = [
    { to: `/admin-dashboard/${uid}/allvolunteers`, label: "All Volunteers", icon: <FaUser className="me-2" /> },
    { to: `/admin-dashboard/${uid}/organizer-view`, label: "Events", icon: <FaCalendarAlt className="me-2" /> },
    { to: `/admin-dashboard/${uid}/help`, label: "Volunteer Initiatives", icon: <BsClipboardCheckFill className="me-2" /> },
  ];
